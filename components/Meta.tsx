...
const Meta = ({
  title = `Haunted House - 🎃 Where Fright Meets Byte: A Haunted House Hackathon Experience.`, // page title
  name = `Haunted House - 🎃 Where Fright Meets Byte: A Haunted House Hackathon Experience.`, // site name
